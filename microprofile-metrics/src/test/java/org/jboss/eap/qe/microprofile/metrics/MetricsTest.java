...
public class MetricsTest {
    ...
    /**
     * @tpTestDetails Smoke scenario to verify correct behaviour
     * @tpPassCrit metrics are registered
    ...
    /**
     * @tpTestDetails Smoke scenario to verify correct behaviour
     * @tpPassCrit Correct metadata are provided for metrics
     * @tpSince EAP 7.4.0.CD19
     */
    @Test
    @RunAsClient
    ...
    /**
     * @tpTestDetails Smoke scenario to verify correct behaviour
     * @tpPassCrit Correct data are provided for metrics in JSON format
     * @tpSince EAP 7.4.0.CD19
     */
    @Test
    @RunAsClient
    ...
    /**
     * @tpTestDetails Smoke scenario to verify correct behaviour
     * @tpPassCrit Correct data are provided for metrics
     * @tpSince EAP 7.4.0.CD19
     */
    @Test
    @RunAsClient
